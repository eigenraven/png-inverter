 ...
 */
PNG_INVERTER_EXPORT const char *get_version();
...
/*! \brief Reads a PNG file, inverts all the colors and writes out a new PNG
   file.
 ...
 */
PNG_INVERTER_EXPORT void invert_png(const char *inFilePath,
